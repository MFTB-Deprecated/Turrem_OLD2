...
/**
 * Urchin is a ball of 'evenly' spaced rays expanding out from an origin. Named
 * because a sea urchin has lots of outward pointing spikes.
 */
public class Urchin
{
	public AORay[] rays;
	...
	/**
	 * The sum of the magnitude of each ray in the positive X direction. Used to
	 * create an average magnitude.
	 */
	public float xu = 0.0F;
	/**
	 * The sum of the magnitude of each ray in the negative X direction. Used to
	 * create an average magnitude.
	 */
	public float xd = 0.0F;
	/**
	 * The sum of the magnitude of each ray in the positive Y direction. Used to
	 * create an average magnitude.
	 */
	public float yu = 0.0F;
	/**
	 * The sum of the magnitude of each ray in the negative Y direction. Used to
	 * create an average magnitude.
	 */
	public float yd = 0.0F;
	/**
	 * The sum of the magnitude of each ray in the positive Z direction. Used to
	 * create an average magnitude.
	 */
	public float zu = 0.0F;
	/**
	 * The sum of the magnitude of each ray in the negative Z direction. Used to
	 * create an average magnitude.
	 */
