...
public class PlayerFace
{
	...
	public void tickCamera(ClientWorld world)
	{
		...
		if (iheight != Integer.MIN_VALUE)
		{
			...
			this.camFocus.yCoord *= PlayerFace.hdamp;
			this.camFocus.yCoord += height * (1.0F - PlayerFace.hdamp);
			this.camLoc.yCoord *= PlayerFace.hdamp;
			this.camLoc.yCoord += height * (1.0F - PlayerFace.hdamp);
		}
		this.mouselastx = Mouse.getX();
		this.mouselasty = Mouse.getY();
